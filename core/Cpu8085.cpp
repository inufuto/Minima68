...
const Cpu8085::Instruction Cpu8085::Instructions[] = {
	{ 4, "NOP",Nop},
	{ 10,"LXI\tB,w", [](Cpu8085& cpu)
	{
		/* 01 LXI B, nn */
		cpu.LoadWordConst(cpu.bc.word);
	} },
	{ 7,"STAX\tB", [](Cpu8085& cpu)
	{
		/* 02 STAX B */
	...
	{ 10,"DAD\tB", [](Cpu8085& cpu)
	{
		/* 09 DAD B */
		cpu.AddWord(cpu.hl.word, cpu.bc.word);
	} },
	{ 7,"LDAX\tB", [](Cpu8085& cpu)
	{
		/* 0a LDAX B */
	...
	{10,"LXI\tD,w",[](Cpu8085& cpu)
	{
		/* 11 LXI D, nn */
		cpu.LoadWordConst(cpu.de.word);
	}},
	{7,"STAX\tD",[](Cpu8085& cpu)
	{
		/* 12 STAX D */
	...
	{10,"DAD\tD",[](Cpu8085& cpu)
	{
		/* 19 DAD D */
		cpu.AddWord(cpu.hl.word, cpu.de.word);
	}},
	{7,"LDAX\tD",[](Cpu8085& cpu)
	{
		/* 1a LDAX D */
	...
	{10,"LXI\tH,w",[](Cpu8085& cpu)
	{
		/* 21 LXI H, nn */
		cpu.LoadWordConst(cpu.hl.word);
	}},
	{7,"SHLD\tw",[](Cpu8085& cpu)
	{
		/* 22 SHLD nn */
	...
	{7 /* or 11 */,"ADI\tb",[](Cpu8085& cpu)
	{
		/* c6 ADI n */
		cpu.AddByteImmediate(cpu.af.high);
	}},
	{12,"RST\t0",[](Cpu8085& cpu)
	{
		/* c7 RST 0 */
		cpu.Call(0x00);
	} },
	{6 /* or 12 */,"RZ",[](Cpu8085& cpu)
	{
		/* c8 RZ */
		cpu.ReturnIf([](const uint8_t flags) {
	...
	{6 /* or 12 */,"RSTV",[](Cpu8085& cpu)
	{
		/* cb *RSTV */
		cpu.RestartIfOverflow();
	} },
	{ 9 /* or 18 */, "CZ\tw",[](Cpu8085& cpu)
	{
		/* cc CZ nn */
		cpu.CallIf([](const uint8_t flags) {
			return (flags & Flag::Zero) != 0;
	...
	{7 /* or 11 */,"ACI\tb",[](Cpu8085& cpu)
	{
		/* ce ACI n */
		cpu.AddByteImmediateWithCarry(cpu.af.high);
	}},
	{12,"RST\t1",[](Cpu8085& cpu)
	{
		/* cf RST 1 */
		cpu.Call(0x08);
	} },
	{ 6 /* or 12 */,"RNC",[](Cpu8085& cpu)
	{
		/* d0 RNC */
		cpu.ReturnIf([](const uint8_t flags) {
	...
	{12,"RST\t2",[](Cpu8085& cpu)
	{
		/* d7 RST 2 */
		cpu.Call(0x10);
	} },
	{6 /* or 12 */,"RC",[](Cpu8085& cpu)
	{
		/* d8 RC */
		cpu.ReturnIf([](const uint8_t flags) {
	...
	{12,"RST\t3",[](Cpu8085& cpu)
	{
		/* df RST 3 */
		cpu.Call(0x18);
	} },
	{6 /* or 12 */,"RPO",[](Cpu8085& cpu)
	{
		/* e0 RPO */
		cpu.ReturnIf([](const uint8_t flags) {
	...
	{12,"RST\t4",[](Cpu8085& cpu)
	{
		/* e7 RST 4 */
		cpu.Call(0x20);
	} },
	{6 /* or 12 */,"RPE",[](Cpu8085& cpu)
	{
		/* e8 RPE */
		cpu.ReturnIf([](const uint8_t flags) {
	...
	{12,"RST\t5",[](Cpu8085& cpu)
	{
		/* ef RST 5 */
		cpu.Call(0x28);
	} },
	{6 /* or 12 */,"RP",[](Cpu8085& cpu)
	{
		/* f0 RP */
		cpu.ReturnIf([](const uint8_t flags) {
	...
	{12,"RST\t6",[](Cpu8085& cpu)
	{
		/* f7 RST 6 */
		cpu.Call(0x30);
	} },
	{6 /* or 12 */,"RM",[](Cpu8085& cpu)
	{
		/* f8 RM */
		cpu.ReturnIf([](const uint8_t flags) {
...
void Cpu8085::PushWord(const uint16_t value)
{
...
void Cpu8085::UpdateOverflowForAddition(uint8_t destination, uint8_t source, uint8_t result)
{
...
void Cpu8085::UpdateOverflowForSubtraction(uint8_t destination, uint8_t source, uint8_t result)
{
...
void Cpu8085::MoveImmediateMemory(uint16_t address)
{
	uint8_t value;
	MoveImmediate(value);
...
void Cpu8085::AddByteMemory(uint8_t& destination, uint16_t address)
{
...
void Cpu8085::AddByteWithCarry(uint8_t& destination, uint8_t source)
{
...
void Cpu8085::AddByteMemoryWithCarry(uint8_t& destination, uint16_t address)
{
	auto value = pMemorySpace->Read(address);
...
void Cpu8085::SubtractByte(uint8_t& destination, uint8_t source)
{
...
void Cpu8085::SubtractByteMemory(uint8_t& destination, const uint16_t address)
{
	auto value = pMemorySpace->Read(address);
...
void Cpu8085::SubtractByteWithCarry(uint8_t& destination, const uint8_t source)
{
	auto carry = (af.low & Flag::Carry) != 0 ? 1 : 0;
...
void Cpu8085::SubtractByteMemoryWithCarry(uint8_t& destination, const uint16_t address)
{
	auto value = pMemorySpace->Read(address);
...
void Cpu8085::AndByte(uint8_t& destination, const uint8_t source)
{
	destination &= source;
...
void Cpu8085::AndByteMemory(uint8_t& destination, const uint16_t address)
{
	auto value = pMemorySpace->Read(address);
...
void Cpu8085::XorByte(uint8_t& destination, const uint8_t source)
{
	destination ^= source;
	UpdateZeroSignParity(destination);
	ClearFlag(Flag::Carry);
...
void Cpu8085::XorByteMemory(uint8_t& destination, const uint16_t address)
{
	auto value = pMemorySpace->Read(address);
...
void Cpu8085::OrByte(uint8_t& destination, const uint8_t source)
{
	destination |= source;
	UpdateZeroSignParity(destination);
	ClearFlag(Flag::Carry);
...
void Cpu8085::OrByteMemory(uint8_t& destination, const uint16_t address)
{
	auto value = pMemorySpace->Read(address);
...
void Cpu8085::CompareByte(const uint8_t destination, const uint8_t source)
{
	uint8_t dummy = destination;
	SubtractByte(dummy, source);
}

void Cpu8085::CompareByteMemory(const uint8_t destination, const uint16_t source)
{
	auto value = pMemorySpace->Read(source);
	CompareByte(destination, value);
}

void Cpu8085::IncreaseByte(uint8_t& byteRegister, const int offset)
{
...
void Cpu8085::IncreaseMemory(const uint16_t address, const int offset)
{
	auto value = pMemorySpace->Read(address);
...
void Cpu8085::RotateLeftCircular(uint8_t& byteRegister)
{
...
void Cpu8085::RotateRightCircular(uint8_t& byteRegister)
{
...
void Cpu8085::RotateLeft(uint8_t& byteRegister)
{
	auto highBit = byteRegister & 0x80;
...
void Cpu8085::RotateRight(uint8_t& byteRegister)
{
	auto lowBit = byteRegister & 1;
...
void Cpu8085::DecimalAdjust(uint8_t& byteRegister)
{
...
void Cpu8085::LoadWordMemory(uint16_t& wordRegister)
{
...
void Cpu8085::LoadWord(uint16_t& wordRegister, const uint16_t address) const
{
	auto low = pMemorySpace->Read(address);
	auto high = pMemorySpace->Read(address + 1);
	wordRegister = MakeWord(high, low);
...
void Cpu8085::StoreWord(uint16_t address, uint16_t value)
{
	pMemorySpace->Write(address, LowByte(value));
	pMemorySpace->Write(address + 1, HighByte(value));
}

void Cpu8085::AddWord(uint16_t& wordRegister, const uint16_t value)
{
...
void Cpu8085::SubtractWord(uint16_t& wordRegister, uint16_t value)
{
...
void Cpu8085::IncreaseWord(uint16_t& wordRegister, const int offset)
{
...
void Cpu8085::AddWordByteConst(uint16_t& destination, const uint16_t source)
{
	auto byteValue = FetchByte();
	destination = source + byteValue;
}

void Cpu8085::ShiftWordRightArithmetic(uint16_t& wordRegister)
{
...
void Cpu8085::RotateWordLeft(uint16_t& wordRegister)
{
...
void Cpu8085::Exchange(uint16_t& word1, uint16_t& word2)
{
	auto temp = word1;
	word1 = word2;
	word2 = temp;
...
void Cpu8085::ExchangeStack(uint16_t& wordRegister)
{
	auto temp = PopWord();
...
void Cpu8085::Jump(const uint16_t address) {
	pc = address;
	//FetchInstruction();
}
...
void Cpu8085::JumpIf(const std::function<bool(uint8_t)>& condition)
{
	if (condition(af.low)) {
...
void Cpu8085::Call(const uint16_t address)
{
	PushWord(pc);
	pc = address;
	//FetchInstruction();
...
void Cpu8085::CallIf(const std::function<bool(uint8_t)>& condition)
{
	if (condition(af.low)) {
...
void Cpu8085::ReturnIf(const std::function<bool(uint8_t)>& condition)
{
	if (condition(af.low)) {
...
void Cpu8085::RestartIfOverflow()
{
	static const Instruction Rst8 = { 12,"RST\t8",[](Cpu8085& cpu)
	{
		cpu.Call(0x40);
	} };
...
void Cpu8085::Input(uint8_t& byteRegister)
{
...
void Cpu8085::OnClock(uint32_t time)
{
...
int Cpu8085::GetRegisterCount() const
{
	return std::size(RegisterViews);
}

const char* Cpu8085::GetRegisterName(int index) const
{
	assert(index >= 0 && index < GetRegisterCount());
	return RegisterViews[index].name.c_str();
}

int Cpu8085::GetRegisterSize(int index) const
{
	assert(index >= 0 && index < GetRegisterCount());
	return RegisterViews[index].size;
}

uint16_t Cpu8085::ReadRegister(int index) const
{
	assert(index >= 0 && index < GetRegisterCount());
	return RegisterViews[index].read(*this);
}

void Cpu8085::WriteRegister(int index, uint16_t value)
{
	assert(index >= 0 && index < GetRegisterCount());
